...
<head>
 ...
 -->
    ...
    <title>Accommodation & Transportation</title>
</head>
...
?>
        ...
        <h1>
                ...
                <hr>
                <img src="../../pic/new_pic/acco/Bus system in Kaohsiung.jpg" alt="" width="65%">
                <hr>
                </h1>
        </div>
        <div id="sobtn">
...
$sql = $db->query("SELECT *FROM`acco` ORDER BY `upload_time`DESC LIMIT 5");
?>
</div>
<?php
$num = $sql->rowCount();
...
<a href="#wait_pic1">
<button class="load-btn" onclick="load('acco',<?=$sortway?>,<?=$reset?>)">load</button>
</a>
    <div id="wait_pic1">
